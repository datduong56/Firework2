...
const FIREWORK_ACCELERATION = 1.0005;
...
const FIREWORK_SPEED = 8;
// Base length of firework trails.
const FIREWORK_TRAIL_LENGTH = 5;
...
const PARTICLE_DECAY_MIN = 0.003;
// Maximum particle decay rate.
const PARTICLE_DECAY_MAX = 0.01;
